 ...
 */
class File extends \OriginalAppName\Config
{
    ...
    public function uploadFile($fileId, $file)
    {
        ...
        $file = \OriginalAppName\Helper::convertArrayToObject($file);
        $fileInformation = \OriginalAppName\Helper::convertArrayToObject(pathinfo($file->name));

        // handy variable names
        $friendlyFileName = \OriginalAppName\Helper::slugify($fileInformation->filename);
