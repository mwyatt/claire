...
CREATE TABLE `tennisPlayer` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `yearId` int(10) unsigned NOT NULL,
  `nameFirst` varchar(75) NULL DEFAULT NULL,
  `nameLast` varchar(75) NULL DEFAULT NULL,
  `slug` VARCHAR(255) NULL DEFAULT NULL,
  `rank` int(10) unsigned DEFAULT NULL,
  `phoneLandline` varchar(30) NULL DEFAULT NULL,
  `phoneMobile` varchar(30) NULL DEFAULT NULL,
  `ettaLicenseNumber` varchar(10) NULL DEFAULT NULL,
