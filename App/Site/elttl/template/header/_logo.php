<a href="<?php echo $this->url->generate() ?>" class="header-logo">
    <span class="header-logo-emblem"><img class="header-logo-emblem-image" src="<?php echo $this->getAssetPath('logo-emblem.svg') ?>" onerror="this.src=''; this.onerror=null;"></span>
