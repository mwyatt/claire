...
<?php if (array_key_exists('thumb', $media) && array_key_exists('150', $media['thumb'])): ?>
	...
	<a href="<?php echo $this->getUrl('admin') ?>media/?edit=<?php echo $media['id'] ?>" class="media-thumb">
		<img src="<?php echo $media['thumb']['150'] ?>" alt="<?php echo $media['title'] ?>">
	</a>

<?php endif ?>

	<p class="media-title"><a href="<?php echo $this->getUrl('admin') ?>media/?edit=<?php echo $media['id'] ?>" class="media-title-link"><?php echo $media['title'] ?></a></p>
	...
	<a href="<?php echo $this->getUrl('admin') ?>media/?delete=<?php echo $media['id'] ?>" class="media-delete js-media-delete">Delete</a>
</div>
