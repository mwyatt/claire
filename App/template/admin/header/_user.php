...
<div class="nav-user js-hover-addclass nav-main-level1">
    ...
    <a class="nav-user-name ellipsis" href="<?php echo $this->getUrl() ?>admin/profile/" class="name js-hover-addclass-trigger"><?php echo ($adminUser->getNameFirst() ? $adminUser->getNameFirst() . ' ' . $adminUser->getNameLast() : $adminUser->getEmail()) ?></a>
