...
<?php // include $this->getTemplatePath('_logo') ?>
	...
	<form method="post" action="" class="form-login">
        ...
        <input id="login-email" class="input-text w100" type="text" name="email" autofocus="autofocus" value="<?php echo $sessionForm['email'] ?>" required>
        <label class="label-block" for="login-password">Password</label>
        <input id="login-password" class="input-text w100" type="password" name="password" required>
        <input type="hidden" name="login" value="true">
        <button type="submit" class="button-primary right mt1">Login</button>
    ...
    <div id="js-lightbox-forgot-password" class="mfp-hide">
        ...
        <form action="" method="post" class="form-forgot-password js-form-forgot-password">
            <label class="label-block" for="login-email">Email</label>
            <input id="login-email" class="input-text w100" type="text" name="email" autofocus="autofocus" value="<?php echo $sessionForm['email'] ?>" required>
            <button type="submit" class="button-primary right mt1 js-form-forgot-password-submit">Reset Password</button>
        </form>
    </div>
</div>
