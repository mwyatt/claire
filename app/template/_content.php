...
<?php $theUrl = $this->url->build([$content->getType(), $content->getSlug()]) ?>
...
<?php if ($this->isAdmin()): ?>
	...
	<div class="content-action">
		<!-- <a class="content-action-link" href="<?php echo $theUrl ?>" title="View <?php echo $content->getTitle() ?> online" target="blank">View</a> -->
