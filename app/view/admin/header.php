...
<?php if (! $this->get('options', 'season_status') && $this->get($this->session->get('user'), 'email') == 'martin.wyatt@gmail.com'): ?>
    ...
    <div class="notice season-status clearfix">
        <h3>Season Status</h3>
        <p>This season has not yet started. Please ensure all <a href="<?php echo $this->urlHome() ?>league/team/" title="Team management">teams</a> are in the correct divisions. Once you 'start' the season the fixtures will be generated and you will be unable to move <a href="<?php echo $this->urlHome() ?>league/team/" title="Team management">teams</a> to other divisions.</p>
