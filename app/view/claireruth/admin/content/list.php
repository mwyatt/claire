...
<?php if ($statuses): ?>
	<?php foreach ($statuses as $status): ?>
		...
		<a class="button right" href="<?php echo $this->getUrl('current_noquery') ?>?status=<?php echo $status ?>">Status: <?php echo ucfirst($status) ?></a>
...
<?php if (! $contents): ?>
	...
	<div class="nothing-yet">
		<p>No <?php echo ucfirst($this->url->getPathPart(2)) ?> have been created yet, why not <a href="<?php echo $this->getUrl('current_noquery') ?>new/">create</a> one now?</p>
	</div>
