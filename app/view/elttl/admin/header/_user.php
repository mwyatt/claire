...
<div class="nav-user js-hover-addclass nav-main-level1">
    <a class="nav-user-name ellipsis" href="<?php echo $this->getUrl() ?>admin/profile/" class="name js-hover-addclass-trigger"><?php echo ($user->first_name ? $user->first_name . ' ' . $user->last_name : $user->email) ?></a>
