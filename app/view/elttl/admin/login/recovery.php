    	...
    	<![endif]-->
       	...
       	<div class="wrap">
    		<div class="content login clearfix">
    			<a class="logo" href="<?php echo $this->getUrl() ?>" title="Open Homepage"><span>4</span></a>
...
<?php echo $this->getFeedback() ?>
            ...
            <script src="<?php echo $this->getUrl() ?>js/vendor/jquery-1.8.2.min.js"></script>
            <script src="<?php echo $this->getUrl() ?>js/admin/main.js"></script>
    	</div>
    </body>
</html>