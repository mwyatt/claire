...
<div class="page tennis-fixture-single">
	<h2><?php echo ($fixture ? 'Update' : 'Fulfill') ?> scorecard</h2>
	<form class="main" method="post">

<?php if ($this->get('model_ttdivision')): ?>

		<div class="row division<?php echo ($fixture ? ' hidden' : '') ?>">
...
<?php endif ?>
		...
		<div class="row team<?php echo ($fixture ? ' hidden' : '') ?>">
			<select id="team_left" name="team[left]">
				<option value="<?php echo ($fixture ? $this->get('fixture', 'team_left_id') : '0') ?>">Home team</option>
			</select>
			<select id="team_right" name="team[right]">
				<option value="<?php echo ($fixture ? $this->get('fixture', 'team_right_id') : '0') ?>">Away team</option>
			</select>
		</div>
...
<?php echo (! $fixture ? '<span class="play-up button left">Play up</span>' : '') ?>
...
<?php echo (! $fixture ? '<span class="play-up button right">Play up</span>' : '') ?>
...
<?php endforeach; ?>
		...
		<div class="row">
			<a href="#" class="submit button"><?php echo ($fixture ? 'Update' : 'Fulfill') ?> Fixture</a>
		</div>
		<input name="form_<?php echo ($fixture ? 'update' : 'fulfill') ?>" type="hidden">
		<input type="submit">
	</form>
</div>
