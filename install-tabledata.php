...
try {
	...
	$database->dbh->query("
		...
		(81, 'Peter', 'Marsland', 1576, 16),
		(82, 'John', 'Collins', 1841, 18),
		(84, 'David', 'Borland', 1840, 19),
		(85, 'Alan', 'Calow', 1872, 19),
		(86, 'Craig', 'Milnes', 1742, 18),
		(87, 'Paul', 'Wood', 1646, 41),
		(88, 'Phil', 'Mileham', 1856, 19),
		(90, 'Graham', 'Meloy', 1536, 17),
		(91, 'Grant', 'Saggers', 1399, 20),
		(92, 'Alan', 'Duckworth', 1608, 15),
		...
		(114, 'Martin', 'Drury', 1581, 22),
		(115, 'Philip', 'Grace', 1248, 26),
		(116, 'Chris', 'Booth', 1240, 25),
